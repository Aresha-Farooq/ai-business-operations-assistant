...
Your data contract is the heart of your application. It lives at [`packages/database/prisma/schema.prisma`](packages/database/prisma/schema.prisma) and describes your models:
...
```typescript
import { db } from './packages/database/prisma/db';
...
export default definePrismaConfig({
  orm: ormConfig({
    contract: './packages/database/prisma/schema.prisma',
    db: {
...
| File | Purpose |
|---|---|
| [`packages/database/prisma/schema.prisma`](packages/database/prisma/schema.prisma) | Your data contract — define your models here |
| [`prisma.config.ts`](prisma.config.ts) | CLI configuration |
| [`packages/database/prisma/db.ts`](packages/database/prisma/db.ts) | Database client — `import { db } from './packages/database/prisma/db'` |
| `packages/database/prisma/contract.json` | Compiled contract (generated) |
| `packages/database/prisma/contract.d.ts` | Contract types (generated) |

### Workflow

1. Edit [`packages/database/prisma/schema.prisma`](packages/database/prisma/schema.prisma) to add or change models.
